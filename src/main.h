...
u8 __xdata last_error_type;    // Last error type for LCD display (0=none,
                               // 1=voltage, 2-5=motor1-4)
u8 __xdata last_error_subtype; // Last error subtype (0=low voltage, 1=recovery)
__bit giay_out;
__bit phut_out;
__bit flip_pulse;
...
__bit chop;
__code u8 mode_select[8][17] = {"      EXIT      ", "  CHINH GIO KIM ",
                                " CHINH GIO THUC ", "    CANH KIM    ",
                                "    TEST MP3    ", "   DIEN THOAI   ",
                                " NGAY THANG NAM ", "   CAM DELAY   "};
