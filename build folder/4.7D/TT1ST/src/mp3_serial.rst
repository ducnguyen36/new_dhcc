      ...
      00829C 22               [24]  553 	ret
                                    ...
                                    568 ;	-----------------------------------------
      00829D                        569 _mp3_play:
      00829D AF 82            [24]  570 	mov	r7,dpl
                                    571 ;	src\mp3_serial.c:15: u16 song = hour*100+minute; //13:47 => 1347 //hour*12 + minute/5 + date*1000
      00829F AD 19            [24]  572 	mov	r5,_mp3_play_PARM_2
      0082A1 7E 00            [12]  573 	mov	r6,#0x00
      0082A3 8D 1B            [24]  574 	mov	__mulint_PARM_2,r5
      0082A5 8E 1C            [24]  575 	mov	(__mulint_PARM_2 + 1),r6
      0082A7 90 00 64         [24]  576 	mov	dptr,#0x0064
      0082AA C0 07            [24]  577 	push	ar7
      0082AC C0 06            [24]  578 	push	ar6
      0082AE C0 05            [24]  579 	push	ar5
      0082B0 12 83 E0         [24]  580 	lcall	__mulint
      0082B3 AB 82            [24]  581 	mov	r3,dpl
      0082B5 AC 83            [24]  582 	mov	r4,dph
      0082B7 D0 05            [24]  583 	pop	ar5
      0082B9 D0 06            [24]  584 	pop	ar6
      0082BB D0 07            [24]  585 	pop	ar7
      0082BD A9 1A            [24]  586 	mov	r1,_mp3_play_PARM_3
      0082BF 7A 00            [12]  587 	mov	r2,#0x00
      0082C1 E9               [12]  588 	mov	a,r1
      0082C2 2B               [12]  589 	add	a,r3
      0082C3 FB               [12]  590 	mov	r3,a
      0082C4 EA               [12]  591 	mov	a,r2
      0082C5 3C               [12]  592 	addc	a,r4
      0082C6 FC               [12]  593 	mov	r4,a
                                    594 ;	src\mp3_serial.c:16: if(date<10) song = hour*12 + minute/5 + date*1000; //13:47 => 1347 //hour*12 + minute/5 + date*1000
      0082C7 BF 0A 00         [24]  595 	cjne	r7,#0x0a,00128$
      0082CA                        596 00128$:
      0082CA 50 56            [24]  597 	jnc	00102$
      0082CC 8D 1B            [24]  598 	mov	__mulint_PARM_2,r5
      0082CE 8E 1C            [24]  599 	mov	(__mulint_PARM_2 + 1),r6
      0082D0 90 00 0C         [24]  600 	mov	dptr,#0x000c
      0082D3 C0 07            [24]  601 	push	ar7
      0082D5 C0 02            [24]  602 	push	ar2
      0082D7 C0 01            [24]  603 	push	ar1
      0082D9 12 83 E0         [24]  604 	lcall	__mulint
      0082DC AD 82            [24]  605 	mov	r5,dpl
      0082DE AE 83            [24]  606 	mov	r6,dph
      0082E0 D0 01            [24]  607 	pop	ar1
      0082E2 D0 02            [24]  608 	pop	ar2
      0082E4 75 1B 05         [24]  609 	mov	__divsint_PARM_2,#0x05
      0082E7 75 1C 00         [24]  610 	mov	(__divsint_PARM_2 + 1),#0x00
      0082EA 89 82            [24]  611 	mov	dpl,r1
      0082EC 8A 83            [24]  612 	mov	dph,r2
      0082EE C0 06            [24]  613 	push	ar6
      0082F0 C0 05            [24]  614 	push	ar5
      0082F2 12 84 9C         [24]  615 	lcall	__divsint
      0082F5 A9 82            [24]  616 	mov	r1,dpl
      0082F7 AA 83            [24]  617 	mov	r2,dph
      0082F9 D0 05            [24]  618 	pop	ar5
      0082FB D0 06            [24]  619 	pop	ar6
      0082FD D0 07            [24]  620 	pop	ar7
      0082FF E9               [12]  621 	mov	a,r1
      008300 2D               [12]  622 	add	a,r5
      008301 FD               [12]  623 	mov	r5,a
      008302 EA               [12]  624 	mov	a,r2
      008303 3E               [12]  625 	addc	a,r6
      008304 FE               [12]  626 	mov	r6,a
      008305 8F 1B            [24]  627 	mov	__mulint_PARM_2,r7
      008307 75 1C 00         [24]  628 	mov	(__mulint_PARM_2 + 1),#0x00
      00830A 90 03 E8         [24]  629 	mov	dptr,#0x03e8
      00830D C0 06            [24]  630 	push	ar6
      00830F C0 05            [24]  631 	push	ar5
      008311 12 83 E0         [24]  632 	lcall	__mulint
      008314 AA 82            [24]  633 	mov	r2,dpl
      008316 AF 83            [24]  634 	mov	r7,dph
      008318 D0 05            [24]  635 	pop	ar5
      00831A D0 06            [24]  636 	pop	ar6
      00831C EA               [12]  637 	mov	a,r2
      00831D 2D               [12]  638 	add	a,r5
      00831E FB               [12]  639 	mov	r3,a
      00831F EF               [12]  640 	mov	a,r7
      008320 3E               [12]  641 	addc	a,r6
      008321 FC               [12]  642 	mov	r4,a
      008322                        643 00102$:
                                    644 ;	src\mp3_serial.c:17: u16 checksum = 65257-((u8)song)-(song>>8);
      008322 8B 07            [24]  645 	mov	ar7,r3
      008324 8F 05            [24]  646 	mov	ar5,r7
      008326 7E 00            [12]  647 	mov	r6,#0x00
      008328 74 E9            [12]  648 	mov	a,#0xe9
      00832A C3               [12]  649 	clr	c
      00832B 9D               [12]  650 	subb	a,r5
      00832C FD               [12]  651 	mov	r5,a
      00832D 74 FE            [12]  652 	mov	a,#0xfe
      00832F 9E               [12]  653 	subb	a,r6
      008330 FE               [12]  654 	mov	r6,a
      008331 8C 01            [24]  655 	mov	ar1,r4
      008333 7A 00            [12]  656 	mov	r2,#0x00
      008335 ED               [12]  657 	mov	a,r5
      008336 C3               [12]  658 	clr	c
      008337 99               [12]  659 	subb	a,r1
      008338 FD               [12]  660 	mov	r5,a
      008339 EE               [12]  661 	mov	a,r6
      00833A 9A               [12]  662 	subb	a,r2
      00833B FE               [12]  663 	mov	r6,a
                                    664 ;	src\mp3_serial.c:18: u8 __xdata mp3_buf[] = {126,255,6,0x12,0,song>>8,song,checksum>>8,checksum,239};
      00833C 90 01 3A         [24]  665 	mov	dptr,#_mp3_play_mp3_buf_65537_5
      00833F 74 7E            [12]  666 	mov	a,#0x7e
      008341 F0               [24]  667 	movx	@dptr,a
      008342 90 01 3B         [24]  668 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0001)
      008345 74 FF            [12]  669 	mov	a,#0xff
      008347 F0               [24]  670 	movx	@dptr,a
      008348 90 01 3C         [24]  671 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0002)
      00834B 74 06            [12]  672 	mov	a,#0x06
      00834D F0               [24]  673 	movx	@dptr,a
      00834E 90 01 3D         [24]  674 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0003)
      008351 74 12            [12]  675 	mov	a,#0x12
      008353 F0               [24]  676 	movx	@dptr,a
      008354 90 01 3E         [24]  677 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0004)
      008357 E4               [12]  678 	clr	a
      008358 F0               [24]  679 	movx	@dptr,a
      008359 8C 03            [24]  680 	mov	ar3,r4
      00835B 90 01 3F         [24]  681 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0005)
      00835E EB               [12]  682 	mov	a,r3
      00835F F0               [24]  683 	movx	@dptr,a
      008360 90 01 40         [24]  684 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0006)
      008363 EF               [12]  685 	mov	a,r7
      008364 F0               [24]  686 	movx	@dptr,a
      008365 8E 07            [24]  687 	mov	ar7,r6
      008367 90 01 41         [24]  688 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0007)
      00836A EF               [12]  689 	mov	a,r7
      00836B F0               [24]  690 	movx	@dptr,a
      00836C 90 01 42         [24]  691 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0008)
      00836F ED               [12]  692 	mov	a,r5
      008370 F0               [24]  693 	movx	@dptr,a
      008371 90 01 43         [24]  694 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0009)
      008374 74 EF            [12]  695 	mov	a,#0xef
      008376 F0               [24]  696 	movx	@dptr,a
                                    697 ;	src\mp3_serial.c:20: for(i=0;i<10;i++){
      008377 7F 00            [12]  698 	mov	r7,#0x00
      008379                        699 00107$:
                                    700 ;	src\mp3_serial.c:21: mp3_SBUF = mp3_buf[i];
      008379 EF               [12]  701 	mov	a,r7
      00837A 24 3A            [12]  702 	add	a,#_mp3_play_mp3_buf_65537_5
      00837C F5 82            [12]  703 	mov	dpl,a
      00837E E4               [12]  704 	clr	a
      00837F 34 01            [12]  705 	addc	a,#(_mp3_play_mp3_buf_65537_5 >> 8)
      008381 F5 83            [12]  706 	mov	dph,a
      008383 E0               [24]  707 	movx	a,@dptr
      008384 F5 9B            [12]  708 	mov	_S2BUF,a
                                    709 ;	src\mp3_serial.c:22: while(!mp3_TI)WATCHDOG;
      008386                        710 00103$:
      008386 E5 9A            [12]  711 	mov	a,_S2CON
      008388 03               [12]  712 	rr	a
      008389 54 01            [12]  713 	anl	a,#0x01
      00838B 70 05            [24]  714 	jnz	00105$
      00838D 43 C1 10         [24]  715 	orl	_WDT_CONTR,#0x10
      008390 80 F4            [24]  716 	sjmp	00103$
      008392                        717 00105$:
                                    718 ;	src\mp3_serial.c:23: S2CON &= 0xFD;
      008392 53 9A FD         [24]  719 	anl	_S2CON,#0xfd
                                    720 ;	src\mp3_serial.c:20: for(i=0;i<10;i++){
      008395 0F               [12]  721 	inc	r7
      008396 BF 0A 00         [24]  722 	cjne	r7,#0x0a,00131$
      008399                        723 00131$:
      008399 40 DE            [24]  724 	jc	00107$
                                    725 ;	src\mp3_serial.c:25: }
      00839B 22               [24]  726 	ret
                                    727 	.area CSEG    (CODE)
                                    728 	.area CONST   (CODE)
                                    729 	.area XINIT   (CODE)
