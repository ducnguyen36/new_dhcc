      ...
      00001A                        461 	.ds 1
                                    ...
                                    484 ;--------------------------------------------------------
                                    485 	.area XSEG    (XDATA)
      00013C                        486 _mp3_play_mp3_buf_65537_5:
      00013C                        487 	.ds 10
                                    488 ;--------------------------------------------------------
      ...
      0083E9 22               [24]  553 	ret
                                    ...
                                    568 ;	-----------------------------------------
      0083EA                        569 _mp3_play:
      0083EA AF 82            [24]  570 	mov	r7,dpl
                                    571 ;	src\mp3_serial.c:15: u16 song = hour*100+minute; //13:47 => 1347 //hour*12 + minute/5 + date*1000
      0083EC AD 19            [24]  572 	mov	r5,_mp3_play_PARM_2
      0083EE 7E 00            [12]  573 	mov	r6,#0x00
      0083F0 8D 1B            [24]  574 	mov	__mulint_PARM_2,r5
      0083F2 8E 1C            [24]  575 	mov	(__mulint_PARM_2 + 1),r6
      0083F4 90 00 64         [24]  576 	mov	dptr,#0x0064
      0083F7 C0 07            [24]  577 	push	ar7
      0083F9 C0 06            [24]  578 	push	ar6
      0083FB C0 05            [24]  579 	push	ar5
      0083FD 12 85 2D         [24]  580 	lcall	__mulint
      008400 AB 82            [24]  581 	mov	r3,dpl
      008402 AC 83            [24]  582 	mov	r4,dph
      008404 D0 05            [24]  583 	pop	ar5
      008406 D0 06            [24]  584 	pop	ar6
      008408 D0 07            [24]  585 	pop	ar7
      00840A A9 1A            [24]  586 	mov	r1,_mp3_play_PARM_3
      00840C 7A 00            [12]  587 	mov	r2,#0x00
      00840E E9               [12]  588 	mov	a,r1
      00840F 2B               [12]  589 	add	a,r3
      008410 FB               [12]  590 	mov	r3,a
      008411 EA               [12]  591 	mov	a,r2
      008412 3C               [12]  592 	addc	a,r4
      008413 FC               [12]  593 	mov	r4,a
                                    594 ;	src\mp3_serial.c:16: if(date<10) song = hour*12 + minute/5 + date*1000; //13:47 => 1347 //hour*12 + minute/5 + date*1000
      008414 BF 0A 00         [24]  595 	cjne	r7,#0x0a,00128$
      008417                        596 00128$:
      008417 50 56            [24]  597 	jnc	00102$
      008419 8D 1B            [24]  598 	mov	__mulint_PARM_2,r5
      00841B 8E 1C            [24]  599 	mov	(__mulint_PARM_2 + 1),r6
      00841D 90 00 0C         [24]  600 	mov	dptr,#0x000c
      008420 C0 07            [24]  601 	push	ar7
      008422 C0 02            [24]  602 	push	ar2
      008424 C0 01            [24]  603 	push	ar1
      008426 12 85 2D         [24]  604 	lcall	__mulint
      008429 AD 82            [24]  605 	mov	r5,dpl
      00842B AE 83            [24]  606 	mov	r6,dph
      00842D D0 01            [24]  607 	pop	ar1
      00842F D0 02            [24]  608 	pop	ar2
      008431 75 1B 05         [24]  609 	mov	__divsint_PARM_2,#0x05
      008434 75 1C 00         [24]  610 	mov	(__divsint_PARM_2 + 1),#0x00
      008437 89 82            [24]  611 	mov	dpl,r1
      008439 8A 83            [24]  612 	mov	dph,r2
      00843B C0 06            [24]  613 	push	ar6
      00843D C0 05            [24]  614 	push	ar5
      00843F 12 85 E9         [24]  615 	lcall	__divsint
      008442 A9 82            [24]  616 	mov	r1,dpl
      008444 AA 83            [24]  617 	mov	r2,dph
      008446 D0 05            [24]  618 	pop	ar5
      008448 D0 06            [24]  619 	pop	ar6
      00844A D0 07            [24]  620 	pop	ar7
      00844C E9               [12]  621 	mov	a,r1
      00844D 2D               [12]  622 	add	a,r5
      00844E FD               [12]  623 	mov	r5,a
      00844F EA               [12]  624 	mov	a,r2
      008450 3E               [12]  625 	addc	a,r6
      008451 FE               [12]  626 	mov	r6,a
      008452 8F 1B            [24]  627 	mov	__mulint_PARM_2,r7
      008454 75 1C 00         [24]  628 	mov	(__mulint_PARM_2 + 1),#0x00
      008457 90 03 E8         [24]  629 	mov	dptr,#0x03e8
      00845A C0 06            [24]  630 	push	ar6
      00845C C0 05            [24]  631 	push	ar5
      00845E 12 85 2D         [24]  632 	lcall	__mulint
      008461 AA 82            [24]  633 	mov	r2,dpl
      008463 AF 83            [24]  634 	mov	r7,dph
      008465 D0 05            [24]  635 	pop	ar5
      008467 D0 06            [24]  636 	pop	ar6
      008469 EA               [12]  637 	mov	a,r2
      00846A 2D               [12]  638 	add	a,r5
      00846B FB               [12]  639 	mov	r3,a
      00846C EF               [12]  640 	mov	a,r7
      00846D 3E               [12]  641 	addc	a,r6
      00846E FC               [12]  642 	mov	r4,a
      00846F                        643 00102$:
                                    644 ;	src\mp3_serial.c:17: u16 checksum = 65257-((u8)song)-(song>>8);
      00846F 8B 07            [24]  645 	mov	ar7,r3
      008471 8F 05            [24]  646 	mov	ar5,r7
      008473 7E 00            [12]  647 	mov	r6,#0x00
      008475 74 E9            [12]  648 	mov	a,#0xe9
      008477 C3               [12]  649 	clr	c
      008478 9D               [12]  650 	subb	a,r5
      008479 FD               [12]  651 	mov	r5,a
      00847A 74 FE            [12]  652 	mov	a,#0xfe
      00847C 9E               [12]  653 	subb	a,r6
      00847D FE               [12]  654 	mov	r6,a
      00847E 8C 01            [24]  655 	mov	ar1,r4
      008480 7A 00            [12]  656 	mov	r2,#0x00
      008482 ED               [12]  657 	mov	a,r5
      008483 C3               [12]  658 	clr	c
      008484 99               [12]  659 	subb	a,r1
      008485 FD               [12]  660 	mov	r5,a
      008486 EE               [12]  661 	mov	a,r6
      008487 9A               [12]  662 	subb	a,r2
      008488 FE               [12]  663 	mov	r6,a
                                    664 ;	src\mp3_serial.c:18: u8 __xdata mp3_buf[] = {126,255,6,0x12,0,song>>8,song,checksum>>8,checksum,239};
      008489 90 01 3C         [24]  665 	mov	dptr,#_mp3_play_mp3_buf_65537_5
      00848C 74 7E            [12]  666 	mov	a,#0x7e
      00848E F0               [24]  667 	movx	@dptr,a
      00848F 90 01 3D         [24]  668 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0001)
      008492 74 FF            [12]  669 	mov	a,#0xff
      008494 F0               [24]  670 	movx	@dptr,a
      008495 90 01 3E         [24]  671 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0002)
      008498 74 06            [12]  672 	mov	a,#0x06
      00849A F0               [24]  673 	movx	@dptr,a
      00849B 90 01 3F         [24]  674 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0003)
      00849E 74 12            [12]  675 	mov	a,#0x12
      0084A0 F0               [24]  676 	movx	@dptr,a
      0084A1 90 01 40         [24]  677 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0004)
      0084A4 E4               [12]  678 	clr	a
      0084A5 F0               [24]  679 	movx	@dptr,a
      0084A6 8C 03            [24]  680 	mov	ar3,r4
      0084A8 90 01 41         [24]  681 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0005)
      0084AB EB               [12]  682 	mov	a,r3
      0084AC F0               [24]  683 	movx	@dptr,a
      0084AD 90 01 42         [24]  684 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0006)
      0084B0 EF               [12]  685 	mov	a,r7
      0084B1 F0               [24]  686 	movx	@dptr,a
      0084B2 8E 07            [24]  687 	mov	ar7,r6
      0084B4 90 01 43         [24]  688 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0007)
      0084B7 EF               [12]  689 	mov	a,r7
      0084B8 F0               [24]  690 	movx	@dptr,a
      0084B9 90 01 44         [24]  691 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0008)
      0084BC ED               [12]  692 	mov	a,r5
      0084BD F0               [24]  693 	movx	@dptr,a
      0084BE 90 01 45         [24]  694 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0009)
      0084C1 74 EF            [12]  695 	mov	a,#0xef
      0084C3 F0               [24]  696 	movx	@dptr,a
                                    697 ;	src\mp3_serial.c:20: for(i=0;i<10;i++){
      0084C4 7F 00            [12]  698 	mov	r7,#0x00
      0084C6                        699 00107$:
                                    700 ;	src\mp3_serial.c:21: mp3_SBUF = mp3_buf[i];
      0084C6 EF               [12]  701 	mov	a,r7
      0084C7 24 3C            [12]  702 	add	a,#_mp3_play_mp3_buf_65537_5
      0084C9 F5 82            [12]  703 	mov	dpl,a
      0084CB E4               [12]  704 	clr	a
      0084CC 34 01            [12]  705 	addc	a,#(_mp3_play_mp3_buf_65537_5 >> 8)
      0084CE F5 83            [12]  706 	mov	dph,a
      0084D0 E0               [24]  707 	movx	a,@dptr
      0084D1 F5 9B            [12]  708 	mov	_S2BUF,a
                                    709 ;	src\mp3_serial.c:22: while(!mp3_TI)WATCHDOG;
      0084D3                        710 00103$:
      0084D3 E5 9A            [12]  711 	mov	a,_S2CON
      0084D5 03               [12]  712 	rr	a
      0084D6 54 01            [12]  713 	anl	a,#0x01
      0084D8 70 05            [24]  714 	jnz	00105$
      0084DA 43 C1 10         [24]  715 	orl	_WDT_CONTR,#0x10
      0084DD 80 F4            [24]  716 	sjmp	00103$
      0084DF                        717 00105$:
                                    718 ;	src\mp3_serial.c:23: S2CON &= 0xFD;
      0084DF 53 9A FD         [24]  719 	anl	_S2CON,#0xfd
                                    720 ;	src\mp3_serial.c:20: for(i=0;i<10;i++){
      0084E2 0F               [12]  721 	inc	r7
      0084E3 BF 0A 00         [24]  722 	cjne	r7,#0x0a,00131$
      0084E6                        723 00131$:
      0084E6 40 DE            [24]  724 	jc	00107$
                                    725 ;	src\mp3_serial.c:25: }
      0084E8 22               [24]  726 	ret
                                    727 	.area CSEG    (CODE)
                                    728 	.area CONST   (CODE)
                                    729 	.area XINIT   (CODE)
