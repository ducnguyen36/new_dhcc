      ...
      00820A 22               [24]  553 	ret
                                    ...
                                    568 ;	-----------------------------------------
      00820B                        569 _mp3_play:
      00820B AF 82            [24]  570 	mov	r7,dpl
                                    571 ;	src\mp3_serial.c:15: u16 song = hour*100+minute; //13:47 => 1347 //hour*12 + minute/5 + date*1000
      00820D AD 19            [24]  572 	mov	r5,_mp3_play_PARM_2
      00820F 7E 00            [12]  573 	mov	r6,#0x00
      008211 8D 1B            [24]  574 	mov	__mulint_PARM_2,r5
      008213 8E 1C            [24]  575 	mov	(__mulint_PARM_2 + 1),r6
      008215 90 00 64         [24]  576 	mov	dptr,#0x0064
      008218 C0 07            [24]  577 	push	ar7
      00821A C0 06            [24]  578 	push	ar6
      00821C C0 05            [24]  579 	push	ar5
      00821E 12 83 4E         [24]  580 	lcall	__mulint
      008221 AB 82            [24]  581 	mov	r3,dpl
      008223 AC 83            [24]  582 	mov	r4,dph
      008225 D0 05            [24]  583 	pop	ar5
      008227 D0 06            [24]  584 	pop	ar6
      008229 D0 07            [24]  585 	pop	ar7
      00822B A9 1A            [24]  586 	mov	r1,_mp3_play_PARM_3
      00822D 7A 00            [12]  587 	mov	r2,#0x00
      00822F E9               [12]  588 	mov	a,r1
      008230 2B               [12]  589 	add	a,r3
      008231 FB               [12]  590 	mov	r3,a
      008232 EA               [12]  591 	mov	a,r2
      008233 3C               [12]  592 	addc	a,r4
      008234 FC               [12]  593 	mov	r4,a
                                    594 ;	src\mp3_serial.c:16: if(date<10) song = hour*12 + minute/5 + date*1000; //13:47 => 1347 //hour*12 + minute/5 + date*1000
      008235 BF 0A 00         [24]  595 	cjne	r7,#0x0a,00128$
      008238                        596 00128$:
      008238 50 56            [24]  597 	jnc	00102$
      00823A 8D 1B            [24]  598 	mov	__mulint_PARM_2,r5
      00823C 8E 1C            [24]  599 	mov	(__mulint_PARM_2 + 1),r6
      00823E 90 00 0C         [24]  600 	mov	dptr,#0x000c
      008241 C0 07            [24]  601 	push	ar7
      008243 C0 02            [24]  602 	push	ar2
      008245 C0 01            [24]  603 	push	ar1
      008247 12 83 4E         [24]  604 	lcall	__mulint
      00824A AD 82            [24]  605 	mov	r5,dpl
      00824C AE 83            [24]  606 	mov	r6,dph
      00824E D0 01            [24]  607 	pop	ar1
      008250 D0 02            [24]  608 	pop	ar2
      008252 75 1B 05         [24]  609 	mov	__divsint_PARM_2,#0x05
      008255 75 1C 00         [24]  610 	mov	(__divsint_PARM_2 + 1),#0x00
      008258 89 82            [24]  611 	mov	dpl,r1
      00825A 8A 83            [24]  612 	mov	dph,r2
      00825C C0 06            [24]  613 	push	ar6
      00825E C0 05            [24]  614 	push	ar5
      008260 12 84 0A         [24]  615 	lcall	__divsint
      008263 A9 82            [24]  616 	mov	r1,dpl
      008265 AA 83            [24]  617 	mov	r2,dph
      008267 D0 05            [24]  618 	pop	ar5
      008269 D0 06            [24]  619 	pop	ar6
      00826B D0 07            [24]  620 	pop	ar7
      00826D E9               [12]  621 	mov	a,r1
      00826E 2D               [12]  622 	add	a,r5
      00826F FD               [12]  623 	mov	r5,a
      008270 EA               [12]  624 	mov	a,r2
      008271 3E               [12]  625 	addc	a,r6
      008272 FE               [12]  626 	mov	r6,a
      008273 8F 1B            [24]  627 	mov	__mulint_PARM_2,r7
      008275 75 1C 00         [24]  628 	mov	(__mulint_PARM_2 + 1),#0x00
      008278 90 03 E8         [24]  629 	mov	dptr,#0x03e8
      00827B C0 06            [24]  630 	push	ar6
      00827D C0 05            [24]  631 	push	ar5
      00827F 12 83 4E         [24]  632 	lcall	__mulint
      008282 AA 82            [24]  633 	mov	r2,dpl
      008284 AF 83            [24]  634 	mov	r7,dph
      008286 D0 05            [24]  635 	pop	ar5
      008288 D0 06            [24]  636 	pop	ar6
      00828A EA               [12]  637 	mov	a,r2
      00828B 2D               [12]  638 	add	a,r5
      00828C FB               [12]  639 	mov	r3,a
      00828D EF               [12]  640 	mov	a,r7
      00828E 3E               [12]  641 	addc	a,r6
      00828F FC               [12]  642 	mov	r4,a
      008290                        643 00102$:
                                    644 ;	src\mp3_serial.c:17: u16 checksum = 65257-((u8)song)-(song>>8);
      008290 8B 07            [24]  645 	mov	ar7,r3
      008292 8F 05            [24]  646 	mov	ar5,r7
      008294 7E 00            [12]  647 	mov	r6,#0x00
      008296 74 E9            [12]  648 	mov	a,#0xe9
      008298 C3               [12]  649 	clr	c
      008299 9D               [12]  650 	subb	a,r5
      00829A FD               [12]  651 	mov	r5,a
      00829B 74 FE            [12]  652 	mov	a,#0xfe
      00829D 9E               [12]  653 	subb	a,r6
      00829E FE               [12]  654 	mov	r6,a
      00829F 8C 01            [24]  655 	mov	ar1,r4
      0082A1 7A 00            [12]  656 	mov	r2,#0x00
      0082A3 ED               [12]  657 	mov	a,r5
      0082A4 C3               [12]  658 	clr	c
      0082A5 99               [12]  659 	subb	a,r1
      0082A6 FD               [12]  660 	mov	r5,a
      0082A7 EE               [12]  661 	mov	a,r6
      0082A8 9A               [12]  662 	subb	a,r2
      0082A9 FE               [12]  663 	mov	r6,a
                                    664 ;	src\mp3_serial.c:18: u8 __xdata mp3_buf[] = {126,255,6,0x12,0,song>>8,song,checksum>>8,checksum,239};
      0082AA 90 01 3A         [24]  665 	mov	dptr,#_mp3_play_mp3_buf_65537_5
      0082AD 74 7E            [12]  666 	mov	a,#0x7e
      0082AF F0               [24]  667 	movx	@dptr,a
      0082B0 90 01 3B         [24]  668 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0001)
      0082B3 74 FF            [12]  669 	mov	a,#0xff
      0082B5 F0               [24]  670 	movx	@dptr,a
      0082B6 90 01 3C         [24]  671 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0002)
      0082B9 74 06            [12]  672 	mov	a,#0x06
      0082BB F0               [24]  673 	movx	@dptr,a
      0082BC 90 01 3D         [24]  674 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0003)
      0082BF 74 12            [12]  675 	mov	a,#0x12
      0082C1 F0               [24]  676 	movx	@dptr,a
      0082C2 90 01 3E         [24]  677 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0004)
      0082C5 E4               [12]  678 	clr	a
      0082C6 F0               [24]  679 	movx	@dptr,a
      0082C7 8C 03            [24]  680 	mov	ar3,r4
      0082C9 90 01 3F         [24]  681 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0005)
      0082CC EB               [12]  682 	mov	a,r3
      0082CD F0               [24]  683 	movx	@dptr,a
      0082CE 90 01 40         [24]  684 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0006)
      0082D1 EF               [12]  685 	mov	a,r7
      0082D2 F0               [24]  686 	movx	@dptr,a
      0082D3 8E 07            [24]  687 	mov	ar7,r6
      0082D5 90 01 41         [24]  688 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0007)
      0082D8 EF               [12]  689 	mov	a,r7
      0082D9 F0               [24]  690 	movx	@dptr,a
      0082DA 90 01 42         [24]  691 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0008)
      0082DD ED               [12]  692 	mov	a,r5
      0082DE F0               [24]  693 	movx	@dptr,a
      0082DF 90 01 43         [24]  694 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0009)
      0082E2 74 EF            [12]  695 	mov	a,#0xef
      0082E4 F0               [24]  696 	movx	@dptr,a
                                    697 ;	src\mp3_serial.c:20: for(i=0;i<10;i++){
      0082E5 7F 00            [12]  698 	mov	r7,#0x00
      0082E7                        699 00107$:
                                    700 ;	src\mp3_serial.c:21: mp3_SBUF = mp3_buf[i];
      0082E7 EF               [12]  701 	mov	a,r7
      0082E8 24 3A            [12]  702 	add	a,#_mp3_play_mp3_buf_65537_5
      0082EA F5 82            [12]  703 	mov	dpl,a
      0082EC E4               [12]  704 	clr	a
      0082ED 34 01            [12]  705 	addc	a,#(_mp3_play_mp3_buf_65537_5 >> 8)
      0082EF F5 83            [12]  706 	mov	dph,a
      0082F1 E0               [24]  707 	movx	a,@dptr
      0082F2 F5 9B            [12]  708 	mov	_S2BUF,a
                                    709 ;	src\mp3_serial.c:22: while(!mp3_TI)WATCHDOG;
      0082F4                        710 00103$:
      0082F4 E5 9A            [12]  711 	mov	a,_S2CON
      0082F6 03               [12]  712 	rr	a
      0082F7 54 01            [12]  713 	anl	a,#0x01
      0082F9 70 05            [24]  714 	jnz	00105$
      0082FB 43 C1 10         [24]  715 	orl	_WDT_CONTR,#0x10
      0082FE 80 F4            [24]  716 	sjmp	00103$
      008300                        717 00105$:
                                    718 ;	src\mp3_serial.c:23: S2CON &= 0xFD;
      008300 53 9A FD         [24]  719 	anl	_S2CON,#0xfd
                                    720 ;	src\mp3_serial.c:20: for(i=0;i<10;i++){
      008303 0F               [12]  721 	inc	r7
      008304 BF 0A 00         [24]  722 	cjne	r7,#0x0a,00131$
      008307                        723 00131$:
      008307 40 DE            [24]  724 	jc	00107$
                                    725 ;	src\mp3_serial.c:25: }
      008309 22               [24]  726 	ret
                                    727 	.area CSEG    (CODE)
                                    728 	.area CONST   (CODE)
                                    729 	.area XINIT   (CODE)
