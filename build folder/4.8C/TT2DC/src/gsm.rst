      ...
      000388 75 98 50         [24]  534 	mov	_SCON,#0x50
                                    535 ;	src\gsm.c:10: AUXR |= 0x40;		//Timer1's clock is Fosc (1T)
      00038B 43 8E 40         [24]  536 	orl	_AUXR,#0x40
                                    537 ;	src\gsm.c:11: AUXR &= 0xFE;		//Use Timer1 as baudrate generator
      00038E 53 8E FE         [24]  538 	anl	_AUXR,#0xfe
                                    539 ;	src\gsm.c:12: TL1= (65536 - (FOSC/4/gsm_BAUD));	
      000391 75 8B B2         [24]  540 	mov	_TL1,#0xb2
                                    541 ;	src\gsm.c:13: TH1= (65536 - (FOSC/4/gsm_BAUD))>>8;
      000394 75 8D FF         [24]  542 	mov	_TH1,#0xff
                                    543 ;	src\gsm.c:14: ET1 = 0;
                                    544 ;	assignBit
      000397 C2 AB            [12]  545 	clr	_ET1
                                    546 ;	src\gsm.c:15: TR1 = 1;
                                    547 ;	assignBit
      000399 D2 8E            [12]  548 	setb	_TR1
                                    549 ;	src\gsm.c:16: ES = 1;
                                    550 ;	assignBit
      00039B D2 AC            [12]  551 	setb	_ES
                                    552 ;	src\gsm.c:17: gsm_pw = 1;
                                    553 ;	assignBit
      00039D D2 A0            [12]  554 	setb	_P20
                                    555 ;	src\gsm.c:18: }
      00039F 22               [24]  556 	ret
                                    557 ;------------------------------------------------------------
                                    ...
                                    565 ;	-----------------------------------------
      0003A0                        566 _send_gsm_byte:
                                    567 ;	src\gsm.c:20: if(!dulieu) return;
      0003A0 E5 82            [12]  568 	mov	a,dpl
      0003A2 FF               [12]  569 	mov	r7,a
      0003A3 70 01            [24]  570 	jnz	00102$
      0003A5 22               [24]  571 	ret
      0003A6                        572 00102$:
                                    573 ;	src\gsm.c:21: gsm_TI = 0;
                                    574 ;	assignBit
      0003A6 C2 99            [12]  575 	clr	_TI
                                    576 ;	src\gsm.c:22: gsm_SBUF = dulieu;
      0003A8 8F 99            [24]  577 	mov	_SBUF,r7
                                    578 ;	src\gsm.c:23: while(!gsm_TI)WATCHDOG;
      0003AA                        579 00103$:
      0003AA 20 99 05         [24]  580 	jb	_TI,00105$
      0003AD 43 C1 10         [24]  581 	orl	_WDT_CONTR,#0x10
      0003B0 80 F8            [24]  582 	sjmp	00103$
      0003B2                        583 00105$:
                                    584 ;	src\gsm.c:24: gsm_TI = 0;
                                    585 ;	assignBit
      0003B2 C2 99            [12]  586 	clr	_TI
                                    587 ;	src\gsm.c:25: }
      0003B4 22               [24]  588 	ret
                                    ...
                                    597 ;	-----------------------------------------
      0003B5                        598 _send_gsm_cmd:
      0003B5 AD 82            [24]  599 	mov	r5,dpl
      0003B7 AE 83            [24]  600 	mov	r6,dph
      0003B9 AF F0            [24]  601 	mov	r7,b
                                    602 ;	src\gsm.c:28: gsm_TI = 0;
                                    603 ;	assignBit
      0003BB C2 99            [12]  604 	clr	_TI
                                    605 ;	src\gsm.c:29: while(*cmd){
      0003BD                        606 00106$:
      0003BD 8D 82            [24]  607 	mov	dpl,r5
      0003BF 8E 83            [24]  608 	mov	dph,r6
      0003C1 8F F0            [24]  609 	mov	b,r7
      0003C3 12 83 B9         [24]  610 	lcall	__gptrget
      0003C6 FC               [12]  611 	mov	r4,a
      0003C7 60 21            [24]  612 	jz	00109$
                                    613 ;	src\gsm.c:30: gsm_SBUF = *cmd;
      0003C9 8C 99            [24]  614 	mov	_SBUF,r4
                                    615 ;	src\gsm.c:31: while(!gsm_TI)WATCHDOG;
      0003CB                        616 00101$:
      0003CB 20 99 05         [24]  617 	jb	_TI,00103$
      0003CE 43 C1 10         [24]  618 	orl	_WDT_CONTR,#0x10
      0003D1 80 F8            [24]  619 	sjmp	00101$
      0003D3                        620 00103$:
                                    621 ;	src\gsm.c:32: gsm_TI=0;
                                    622 ;	assignBit
      0003D3 C2 99            [12]  623 	clr	_TI
                                    624 ;	src\gsm.c:33: if(*cmd==26) return;
      0003D5 8D 82            [24]  625 	mov	dpl,r5
      0003D7 8E 83            [24]  626 	mov	dph,r6
      0003D9 8F F0            [24]  627 	mov	b,r7
      0003DB 12 83 B9         [24]  628 	lcall	__gptrget
      0003DE FC               [12]  629 	mov	r4,a
      0003DF BC 1A 01         [24]  630 	cjne	r4,#0x1a,00105$
      0003E2 22               [24]  631 	ret
      0003E3                        632 00105$:
                                    633 ;	src\gsm.c:34: cmd++;
      0003E3 0D               [12]  634 	inc	r5
      0003E4 BD 00 D6         [24]  635 	cjne	r5,#0x00,00106$
      0003E7 0E               [12]  636 	inc	r6
      0003E8 80 D3            [24]  637 	sjmp	00106$
      0003EA                        638 00109$:
                                    639 ;	src\gsm.c:36: }
      0003EA 22               [24]  640 	ret
                                    641 	.area CSEG    (CODE)
                                    642 	.area CONST   (CODE)
                                    643 	.area XINIT   (CODE)
