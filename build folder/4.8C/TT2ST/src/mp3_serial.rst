      ...
      00820B 22               [24]  553 	ret
                                    ...
                                    568 ;	-----------------------------------------
      00820C                        569 _mp3_play:
      00820C AF 82            [24]  570 	mov	r7,dpl
                                    571 ;	src\mp3_serial.c:15: u16 song = hour*100+minute; //13:47 => 1347 //hour*12 + minute/5 + date*1000
      00820E AD 19            [24]  572 	mov	r5,_mp3_play_PARM_2
      008210 7E 00            [12]  573 	mov	r6,#0x00
      008212 8D 1B            [24]  574 	mov	__mulint_PARM_2,r5
      008214 8E 1C            [24]  575 	mov	(__mulint_PARM_2 + 1),r6
      008216 90 00 64         [24]  576 	mov	dptr,#0x0064
      008219 C0 07            [24]  577 	push	ar7
      00821B C0 06            [24]  578 	push	ar6
      00821D C0 05            [24]  579 	push	ar5
      00821F 12 83 4F         [24]  580 	lcall	__mulint
      008222 AB 82            [24]  581 	mov	r3,dpl
      008224 AC 83            [24]  582 	mov	r4,dph
      008226 D0 05            [24]  583 	pop	ar5
      008228 D0 06            [24]  584 	pop	ar6
      00822A D0 07            [24]  585 	pop	ar7
      00822C A9 1A            [24]  586 	mov	r1,_mp3_play_PARM_3
      00822E 7A 00            [12]  587 	mov	r2,#0x00
      008230 E9               [12]  588 	mov	a,r1
      008231 2B               [12]  589 	add	a,r3
      008232 FB               [12]  590 	mov	r3,a
      008233 EA               [12]  591 	mov	a,r2
      008234 3C               [12]  592 	addc	a,r4
      008235 FC               [12]  593 	mov	r4,a
                                    594 ;	src\mp3_serial.c:16: if(date<10) song = hour*12 + minute/5 + date*1000; //13:47 => 1347 //hour*12 + minute/5 + date*1000
      008236 BF 0A 00         [24]  595 	cjne	r7,#0x0a,00128$
      008239                        596 00128$:
      008239 50 56            [24]  597 	jnc	00102$
      00823B 8D 1B            [24]  598 	mov	__mulint_PARM_2,r5
      00823D 8E 1C            [24]  599 	mov	(__mulint_PARM_2 + 1),r6
      00823F 90 00 0C         [24]  600 	mov	dptr,#0x000c
      008242 C0 07            [24]  601 	push	ar7
      008244 C0 02            [24]  602 	push	ar2
      008246 C0 01            [24]  603 	push	ar1
      008248 12 83 4F         [24]  604 	lcall	__mulint
      00824B AD 82            [24]  605 	mov	r5,dpl
      00824D AE 83            [24]  606 	mov	r6,dph
      00824F D0 01            [24]  607 	pop	ar1
      008251 D0 02            [24]  608 	pop	ar2
      008253 75 1B 05         [24]  609 	mov	__divsint_PARM_2,#0x05
      008256 75 1C 00         [24]  610 	mov	(__divsint_PARM_2 + 1),#0x00
      008259 89 82            [24]  611 	mov	dpl,r1
      00825B 8A 83            [24]  612 	mov	dph,r2
      00825D C0 06            [24]  613 	push	ar6
      00825F C0 05            [24]  614 	push	ar5
      008261 12 84 0B         [24]  615 	lcall	__divsint
      008264 A9 82            [24]  616 	mov	r1,dpl
      008266 AA 83            [24]  617 	mov	r2,dph
      008268 D0 05            [24]  618 	pop	ar5
      00826A D0 06            [24]  619 	pop	ar6
      00826C D0 07            [24]  620 	pop	ar7
      00826E E9               [12]  621 	mov	a,r1
      00826F 2D               [12]  622 	add	a,r5
      008270 FD               [12]  623 	mov	r5,a
      008271 EA               [12]  624 	mov	a,r2
      008272 3E               [12]  625 	addc	a,r6
      008273 FE               [12]  626 	mov	r6,a
      008274 8F 1B            [24]  627 	mov	__mulint_PARM_2,r7
      008276 75 1C 00         [24]  628 	mov	(__mulint_PARM_2 + 1),#0x00
      008279 90 03 E8         [24]  629 	mov	dptr,#0x03e8
      00827C C0 06            [24]  630 	push	ar6
      00827E C0 05            [24]  631 	push	ar5
      008280 12 83 4F         [24]  632 	lcall	__mulint
      008283 AA 82            [24]  633 	mov	r2,dpl
      008285 AF 83            [24]  634 	mov	r7,dph
      008287 D0 05            [24]  635 	pop	ar5
      008289 D0 06            [24]  636 	pop	ar6
      00828B EA               [12]  637 	mov	a,r2
      00828C 2D               [12]  638 	add	a,r5
      00828D FB               [12]  639 	mov	r3,a
      00828E EF               [12]  640 	mov	a,r7
      00828F 3E               [12]  641 	addc	a,r6
      008290 FC               [12]  642 	mov	r4,a
      008291                        643 00102$:
                                    644 ;	src\mp3_serial.c:17: u16 checksum = 65257-((u8)song)-(song>>8);
      008291 8B 07            [24]  645 	mov	ar7,r3
      008293 8F 05            [24]  646 	mov	ar5,r7
      008295 7E 00            [12]  647 	mov	r6,#0x00
      008297 74 E9            [12]  648 	mov	a,#0xe9
      008299 C3               [12]  649 	clr	c
      00829A 9D               [12]  650 	subb	a,r5
      00829B FD               [12]  651 	mov	r5,a
      00829C 74 FE            [12]  652 	mov	a,#0xfe
      00829E 9E               [12]  653 	subb	a,r6
      00829F FE               [12]  654 	mov	r6,a
      0082A0 8C 01            [24]  655 	mov	ar1,r4
      0082A2 7A 00            [12]  656 	mov	r2,#0x00
      0082A4 ED               [12]  657 	mov	a,r5
      0082A5 C3               [12]  658 	clr	c
      0082A6 99               [12]  659 	subb	a,r1
      0082A7 FD               [12]  660 	mov	r5,a
      0082A8 EE               [12]  661 	mov	a,r6
      0082A9 9A               [12]  662 	subb	a,r2
      0082AA FE               [12]  663 	mov	r6,a
                                    664 ;	src\mp3_serial.c:18: u8 __xdata mp3_buf[] = {126,255,6,0x12,0,song>>8,song,checksum>>8,checksum,239};
      0082AB 90 01 3A         [24]  665 	mov	dptr,#_mp3_play_mp3_buf_65537_5
      0082AE 74 7E            [12]  666 	mov	a,#0x7e
      0082B0 F0               [24]  667 	movx	@dptr,a
      0082B1 90 01 3B         [24]  668 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0001)
      0082B4 74 FF            [12]  669 	mov	a,#0xff
      0082B6 F0               [24]  670 	movx	@dptr,a
      0082B7 90 01 3C         [24]  671 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0002)
      0082BA 74 06            [12]  672 	mov	a,#0x06
      0082BC F0               [24]  673 	movx	@dptr,a
      0082BD 90 01 3D         [24]  674 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0003)
      0082C0 74 12            [12]  675 	mov	a,#0x12
      0082C2 F0               [24]  676 	movx	@dptr,a
      0082C3 90 01 3E         [24]  677 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0004)
      0082C6 E4               [12]  678 	clr	a
      0082C7 F0               [24]  679 	movx	@dptr,a
      0082C8 8C 03            [24]  680 	mov	ar3,r4
      0082CA 90 01 3F         [24]  681 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0005)
      0082CD EB               [12]  682 	mov	a,r3
      0082CE F0               [24]  683 	movx	@dptr,a
      0082CF 90 01 40         [24]  684 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0006)
      0082D2 EF               [12]  685 	mov	a,r7
      0082D3 F0               [24]  686 	movx	@dptr,a
      0082D4 8E 07            [24]  687 	mov	ar7,r6
      0082D6 90 01 41         [24]  688 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0007)
      0082D9 EF               [12]  689 	mov	a,r7
      0082DA F0               [24]  690 	movx	@dptr,a
      0082DB 90 01 42         [24]  691 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0008)
      0082DE ED               [12]  692 	mov	a,r5
      0082DF F0               [24]  693 	movx	@dptr,a
      0082E0 90 01 43         [24]  694 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0009)
      0082E3 74 EF            [12]  695 	mov	a,#0xef
      0082E5 F0               [24]  696 	movx	@dptr,a
                                    697 ;	src\mp3_serial.c:20: for(i=0;i<10;i++){
      0082E6 7F 00            [12]  698 	mov	r7,#0x00
      0082E8                        699 00107$:
                                    700 ;	src\mp3_serial.c:21: mp3_SBUF = mp3_buf[i];
      0082E8 EF               [12]  701 	mov	a,r7
      0082E9 24 3A            [12]  702 	add	a,#_mp3_play_mp3_buf_65537_5
      0082EB F5 82            [12]  703 	mov	dpl,a
      0082ED E4               [12]  704 	clr	a
      0082EE 34 01            [12]  705 	addc	a,#(_mp3_play_mp3_buf_65537_5 >> 8)
      0082F0 F5 83            [12]  706 	mov	dph,a
      0082F2 E0               [24]  707 	movx	a,@dptr
      0082F3 F5 9B            [12]  708 	mov	_S2BUF,a
                                    709 ;	src\mp3_serial.c:22: while(!mp3_TI)WATCHDOG;
      0082F5                        710 00103$:
      0082F5 E5 9A            [12]  711 	mov	a,_S2CON
      0082F7 03               [12]  712 	rr	a
      0082F8 54 01            [12]  713 	anl	a,#0x01
      0082FA 70 05            [24]  714 	jnz	00105$
      0082FC 43 C1 10         [24]  715 	orl	_WDT_CONTR,#0x10
      0082FF 80 F4            [24]  716 	sjmp	00103$
      008301                        717 00105$:
                                    718 ;	src\mp3_serial.c:23: S2CON &= 0xFD;
      008301 53 9A FD         [24]  719 	anl	_S2CON,#0xfd
                                    720 ;	src\mp3_serial.c:20: for(i=0;i<10;i++){
      008304 0F               [12]  721 	inc	r7
      008305 BF 0A 00         [24]  722 	cjne	r7,#0x0a,00131$
      008308                        723 00131$:
      008308 40 DE            [24]  724 	jc	00107$
                                    725 ;	src\mp3_serial.c:25: }
      00830A 22               [24]  726 	ret
                                    727 	.area CSEG    (CODE)
                                    728 	.area CONST   (CODE)
                                    729 	.area XINIT   (CODE)
