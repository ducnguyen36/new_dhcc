      ...
      008220 22               [24]  553 	ret
                                    ...
                                    568 ;	-----------------------------------------
      008221                        569 _mp3_play:
      008221 AF 82            [24]  570 	mov	r7,dpl
                                    571 ;	src\mp3_serial.c:15: u16 song = hour*100+minute; //13:47 => 1347 //hour*12 + minute/5 + date*1000
      008223 AD 19            [24]  572 	mov	r5,_mp3_play_PARM_2
      008225 7E 00            [12]  573 	mov	r6,#0x00
      008227 8D 1B            [24]  574 	mov	__mulint_PARM_2,r5
      008229 8E 1C            [24]  575 	mov	(__mulint_PARM_2 + 1),r6
      00822B 90 00 64         [24]  576 	mov	dptr,#0x0064
      00822E C0 07            [24]  577 	push	ar7
      008230 C0 06            [24]  578 	push	ar6
      008232 C0 05            [24]  579 	push	ar5
      008234 12 83 64         [24]  580 	lcall	__mulint
      008237 AB 82            [24]  581 	mov	r3,dpl
      008239 AC 83            [24]  582 	mov	r4,dph
      00823B D0 05            [24]  583 	pop	ar5
      00823D D0 06            [24]  584 	pop	ar6
      00823F D0 07            [24]  585 	pop	ar7
      008241 A9 1A            [24]  586 	mov	r1,_mp3_play_PARM_3
      008243 7A 00            [12]  587 	mov	r2,#0x00
      008245 E9               [12]  588 	mov	a,r1
      008246 2B               [12]  589 	add	a,r3
      008247 FB               [12]  590 	mov	r3,a
      008248 EA               [12]  591 	mov	a,r2
      008249 3C               [12]  592 	addc	a,r4
      00824A FC               [12]  593 	mov	r4,a
                                    594 ;	src\mp3_serial.c:16: if(date<10) song = hour*12 + minute/5 + date*1000; //13:47 => 1347 //hour*12 + minute/5 + date*1000
      00824B BF 0A 00         [24]  595 	cjne	r7,#0x0a,00128$
      00824E                        596 00128$:
      00824E 50 56            [24]  597 	jnc	00102$
      008250 8D 1B            [24]  598 	mov	__mulint_PARM_2,r5
      008252 8E 1C            [24]  599 	mov	(__mulint_PARM_2 + 1),r6
      008254 90 00 0C         [24]  600 	mov	dptr,#0x000c
      008257 C0 07            [24]  601 	push	ar7
      008259 C0 02            [24]  602 	push	ar2
      00825B C0 01            [24]  603 	push	ar1
      00825D 12 83 64         [24]  604 	lcall	__mulint
      008260 AD 82            [24]  605 	mov	r5,dpl
      008262 AE 83            [24]  606 	mov	r6,dph
      008264 D0 01            [24]  607 	pop	ar1
      008266 D0 02            [24]  608 	pop	ar2
      008268 75 1B 05         [24]  609 	mov	__divsint_PARM_2,#0x05
      00826B 75 1C 00         [24]  610 	mov	(__divsint_PARM_2 + 1),#0x00
      00826E 89 82            [24]  611 	mov	dpl,r1
      008270 8A 83            [24]  612 	mov	dph,r2
      008272 C0 06            [24]  613 	push	ar6
      008274 C0 05            [24]  614 	push	ar5
      008276 12 84 20         [24]  615 	lcall	__divsint
      008279 A9 82            [24]  616 	mov	r1,dpl
      00827B AA 83            [24]  617 	mov	r2,dph
      00827D D0 05            [24]  618 	pop	ar5
      00827F D0 06            [24]  619 	pop	ar6
      008281 D0 07            [24]  620 	pop	ar7
      008283 E9               [12]  621 	mov	a,r1
      008284 2D               [12]  622 	add	a,r5
      008285 FD               [12]  623 	mov	r5,a
      008286 EA               [12]  624 	mov	a,r2
      008287 3E               [12]  625 	addc	a,r6
      008288 FE               [12]  626 	mov	r6,a
      008289 8F 1B            [24]  627 	mov	__mulint_PARM_2,r7
      00828B 75 1C 00         [24]  628 	mov	(__mulint_PARM_2 + 1),#0x00
      00828E 90 03 E8         [24]  629 	mov	dptr,#0x03e8
      008291 C0 06            [24]  630 	push	ar6
      008293 C0 05            [24]  631 	push	ar5
      008295 12 83 64         [24]  632 	lcall	__mulint
      008298 AA 82            [24]  633 	mov	r2,dpl
      00829A AF 83            [24]  634 	mov	r7,dph
      00829C D0 05            [24]  635 	pop	ar5
      00829E D0 06            [24]  636 	pop	ar6
      0082A0 EA               [12]  637 	mov	a,r2
      0082A1 2D               [12]  638 	add	a,r5
      0082A2 FB               [12]  639 	mov	r3,a
      0082A3 EF               [12]  640 	mov	a,r7
      0082A4 3E               [12]  641 	addc	a,r6
      0082A5 FC               [12]  642 	mov	r4,a
      0082A6                        643 00102$:
                                    644 ;	src\mp3_serial.c:17: u16 checksum = 65257-((u8)song)-(song>>8);
      0082A6 8B 07            [24]  645 	mov	ar7,r3
      0082A8 8F 05            [24]  646 	mov	ar5,r7
      0082AA 7E 00            [12]  647 	mov	r6,#0x00
      0082AC 74 E9            [12]  648 	mov	a,#0xe9
      0082AE C3               [12]  649 	clr	c
      0082AF 9D               [12]  650 	subb	a,r5
      0082B0 FD               [12]  651 	mov	r5,a
      0082B1 74 FE            [12]  652 	mov	a,#0xfe
      0082B3 9E               [12]  653 	subb	a,r6
      0082B4 FE               [12]  654 	mov	r6,a
      0082B5 8C 01            [24]  655 	mov	ar1,r4
      0082B7 7A 00            [12]  656 	mov	r2,#0x00
      0082B9 ED               [12]  657 	mov	a,r5
      0082BA C3               [12]  658 	clr	c
      0082BB 99               [12]  659 	subb	a,r1
      0082BC FD               [12]  660 	mov	r5,a
      0082BD EE               [12]  661 	mov	a,r6
      0082BE 9A               [12]  662 	subb	a,r2
      0082BF FE               [12]  663 	mov	r6,a
                                    664 ;	src\mp3_serial.c:18: u8 __xdata mp3_buf[] = {126,255,6,0x12,0,song>>8,song,checksum>>8,checksum,239};
      0082C0 90 01 3A         [24]  665 	mov	dptr,#_mp3_play_mp3_buf_65537_5
      0082C3 74 7E            [12]  666 	mov	a,#0x7e
      0082C5 F0               [24]  667 	movx	@dptr,a
      0082C6 90 01 3B         [24]  668 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0001)
      0082C9 74 FF            [12]  669 	mov	a,#0xff
      0082CB F0               [24]  670 	movx	@dptr,a
      0082CC 90 01 3C         [24]  671 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0002)
      0082CF 74 06            [12]  672 	mov	a,#0x06
      0082D1 F0               [24]  673 	movx	@dptr,a
      0082D2 90 01 3D         [24]  674 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0003)
      0082D5 74 12            [12]  675 	mov	a,#0x12
      0082D7 F0               [24]  676 	movx	@dptr,a
      0082D8 90 01 3E         [24]  677 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0004)
      0082DB E4               [12]  678 	clr	a
      0082DC F0               [24]  679 	movx	@dptr,a
      0082DD 8C 03            [24]  680 	mov	ar3,r4
      0082DF 90 01 3F         [24]  681 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0005)
      0082E2 EB               [12]  682 	mov	a,r3
      0082E3 F0               [24]  683 	movx	@dptr,a
      0082E4 90 01 40         [24]  684 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0006)
      0082E7 EF               [12]  685 	mov	a,r7
      0082E8 F0               [24]  686 	movx	@dptr,a
      0082E9 8E 07            [24]  687 	mov	ar7,r6
      0082EB 90 01 41         [24]  688 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0007)
      0082EE EF               [12]  689 	mov	a,r7
      0082EF F0               [24]  690 	movx	@dptr,a
      0082F0 90 01 42         [24]  691 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0008)
      0082F3 ED               [12]  692 	mov	a,r5
      0082F4 F0               [24]  693 	movx	@dptr,a
      0082F5 90 01 43         [24]  694 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0009)
      0082F8 74 EF            [12]  695 	mov	a,#0xef
      0082FA F0               [24]  696 	movx	@dptr,a
                                    697 ;	src\mp3_serial.c:20: for(i=0;i<10;i++){
      0082FB 7F 00            [12]  698 	mov	r7,#0x00
      0082FD                        699 00107$:
                                    700 ;	src\mp3_serial.c:21: mp3_SBUF = mp3_buf[i];
      0082FD EF               [12]  701 	mov	a,r7
      0082FE 24 3A            [12]  702 	add	a,#_mp3_play_mp3_buf_65537_5
      008300 F5 82            [12]  703 	mov	dpl,a
      008302 E4               [12]  704 	clr	a
      008303 34 01            [12]  705 	addc	a,#(_mp3_play_mp3_buf_65537_5 >> 8)
      008305 F5 83            [12]  706 	mov	dph,a
      008307 E0               [24]  707 	movx	a,@dptr
      008308 F5 9B            [12]  708 	mov	_S2BUF,a
                                    709 ;	src\mp3_serial.c:22: while(!mp3_TI)WATCHDOG;
      00830A                        710 00103$:
      00830A E5 9A            [12]  711 	mov	a,_S2CON
      00830C 03               [12]  712 	rr	a
      00830D 54 01            [12]  713 	anl	a,#0x01
      00830F 70 05            [24]  714 	jnz	00105$
      008311 43 C1 10         [24]  715 	orl	_WDT_CONTR,#0x10
      008314 80 F4            [24]  716 	sjmp	00103$
      008316                        717 00105$:
                                    718 ;	src\mp3_serial.c:23: S2CON &= 0xFD;
      008316 53 9A FD         [24]  719 	anl	_S2CON,#0xfd
                                    720 ;	src\mp3_serial.c:20: for(i=0;i<10;i++){
      008319 0F               [12]  721 	inc	r7
      00831A BF 0A 00         [24]  722 	cjne	r7,#0x0a,00131$
      00831D                        723 00131$:
      00831D 40 DE            [24]  724 	jc	00107$
                                    725 ;	src\mp3_serial.c:25: }
      00831F 22               [24]  726 	ret
                                    727 	.area CSEG    (CODE)
                                    728 	.area CONST   (CODE)
                                    729 	.area XINIT   (CODE)
