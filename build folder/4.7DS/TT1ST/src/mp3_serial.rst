      ...
      00821F 22               [24]  553 	ret
                                    ...
                                    568 ;	-----------------------------------------
      008220                        569 _mp3_play:
      008220 AF 82            [24]  570 	mov	r7,dpl
                                    571 ;	src\mp3_serial.c:15: u16 song = hour*100+minute; //13:47 => 1347 //hour*12 + minute/5 + date*1000
      008222 AD 19            [24]  572 	mov	r5,_mp3_play_PARM_2
      008224 7E 00            [12]  573 	mov	r6,#0x00
      008226 8D 1B            [24]  574 	mov	__mulint_PARM_2,r5
      008228 8E 1C            [24]  575 	mov	(__mulint_PARM_2 + 1),r6
      00822A 90 00 64         [24]  576 	mov	dptr,#0x0064
      00822D C0 07            [24]  577 	push	ar7
      00822F C0 06            [24]  578 	push	ar6
      008231 C0 05            [24]  579 	push	ar5
      008233 12 83 63         [24]  580 	lcall	__mulint
      008236 AB 82            [24]  581 	mov	r3,dpl
      008238 AC 83            [24]  582 	mov	r4,dph
      00823A D0 05            [24]  583 	pop	ar5
      00823C D0 06            [24]  584 	pop	ar6
      00823E D0 07            [24]  585 	pop	ar7
      008240 A9 1A            [24]  586 	mov	r1,_mp3_play_PARM_3
      008242 7A 00            [12]  587 	mov	r2,#0x00
      008244 E9               [12]  588 	mov	a,r1
      008245 2B               [12]  589 	add	a,r3
      008246 FB               [12]  590 	mov	r3,a
      008247 EA               [12]  591 	mov	a,r2
      008248 3C               [12]  592 	addc	a,r4
      008249 FC               [12]  593 	mov	r4,a
                                    594 ;	src\mp3_serial.c:16: if(date<10) song = hour*12 + minute/5 + date*1000; //13:47 => 1347 //hour*12 + minute/5 + date*1000
      00824A BF 0A 00         [24]  595 	cjne	r7,#0x0a,00128$
      00824D                        596 00128$:
      00824D 50 56            [24]  597 	jnc	00102$
      00824F 8D 1B            [24]  598 	mov	__mulint_PARM_2,r5
      008251 8E 1C            [24]  599 	mov	(__mulint_PARM_2 + 1),r6
      008253 90 00 0C         [24]  600 	mov	dptr,#0x000c
      008256 C0 07            [24]  601 	push	ar7
      008258 C0 02            [24]  602 	push	ar2
      00825A C0 01            [24]  603 	push	ar1
      00825C 12 83 63         [24]  604 	lcall	__mulint
      00825F AD 82            [24]  605 	mov	r5,dpl
      008261 AE 83            [24]  606 	mov	r6,dph
      008263 D0 01            [24]  607 	pop	ar1
      008265 D0 02            [24]  608 	pop	ar2
      008267 75 1B 05         [24]  609 	mov	__divsint_PARM_2,#0x05
      00826A 75 1C 00         [24]  610 	mov	(__divsint_PARM_2 + 1),#0x00
      00826D 89 82            [24]  611 	mov	dpl,r1
      00826F 8A 83            [24]  612 	mov	dph,r2
      008271 C0 06            [24]  613 	push	ar6
      008273 C0 05            [24]  614 	push	ar5
      008275 12 84 1F         [24]  615 	lcall	__divsint
      008278 A9 82            [24]  616 	mov	r1,dpl
      00827A AA 83            [24]  617 	mov	r2,dph
      00827C D0 05            [24]  618 	pop	ar5
      00827E D0 06            [24]  619 	pop	ar6
      008280 D0 07            [24]  620 	pop	ar7
      008282 E9               [12]  621 	mov	a,r1
      008283 2D               [12]  622 	add	a,r5
      008284 FD               [12]  623 	mov	r5,a
      008285 EA               [12]  624 	mov	a,r2
      008286 3E               [12]  625 	addc	a,r6
      008287 FE               [12]  626 	mov	r6,a
      008288 8F 1B            [24]  627 	mov	__mulint_PARM_2,r7
      00828A 75 1C 00         [24]  628 	mov	(__mulint_PARM_2 + 1),#0x00
      00828D 90 03 E8         [24]  629 	mov	dptr,#0x03e8
      008290 C0 06            [24]  630 	push	ar6
      008292 C0 05            [24]  631 	push	ar5
      008294 12 83 63         [24]  632 	lcall	__mulint
      008297 AA 82            [24]  633 	mov	r2,dpl
      008299 AF 83            [24]  634 	mov	r7,dph
      00829B D0 05            [24]  635 	pop	ar5
      00829D D0 06            [24]  636 	pop	ar6
      00829F EA               [12]  637 	mov	a,r2
      0082A0 2D               [12]  638 	add	a,r5
      0082A1 FB               [12]  639 	mov	r3,a
      0082A2 EF               [12]  640 	mov	a,r7
      0082A3 3E               [12]  641 	addc	a,r6
      0082A4 FC               [12]  642 	mov	r4,a
      0082A5                        643 00102$:
                                    644 ;	src\mp3_serial.c:17: u16 checksum = 65257-((u8)song)-(song>>8);
      0082A5 8B 07            [24]  645 	mov	ar7,r3
      0082A7 8F 05            [24]  646 	mov	ar5,r7
      0082A9 7E 00            [12]  647 	mov	r6,#0x00
      0082AB 74 E9            [12]  648 	mov	a,#0xe9
      0082AD C3               [12]  649 	clr	c
      0082AE 9D               [12]  650 	subb	a,r5
      0082AF FD               [12]  651 	mov	r5,a
      0082B0 74 FE            [12]  652 	mov	a,#0xfe
      0082B2 9E               [12]  653 	subb	a,r6
      0082B3 FE               [12]  654 	mov	r6,a
      0082B4 8C 01            [24]  655 	mov	ar1,r4
      0082B6 7A 00            [12]  656 	mov	r2,#0x00
      0082B8 ED               [12]  657 	mov	a,r5
      0082B9 C3               [12]  658 	clr	c
      0082BA 99               [12]  659 	subb	a,r1
      0082BB FD               [12]  660 	mov	r5,a
      0082BC EE               [12]  661 	mov	a,r6
      0082BD 9A               [12]  662 	subb	a,r2
      0082BE FE               [12]  663 	mov	r6,a
                                    664 ;	src\mp3_serial.c:18: u8 __xdata mp3_buf[] = {126,255,6,0x12,0,song>>8,song,checksum>>8,checksum,239};
      0082BF 90 01 3A         [24]  665 	mov	dptr,#_mp3_play_mp3_buf_65537_5
      0082C2 74 7E            [12]  666 	mov	a,#0x7e
      0082C4 F0               [24]  667 	movx	@dptr,a
      0082C5 90 01 3B         [24]  668 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0001)
      0082C8 74 FF            [12]  669 	mov	a,#0xff
      0082CA F0               [24]  670 	movx	@dptr,a
      0082CB 90 01 3C         [24]  671 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0002)
      0082CE 74 06            [12]  672 	mov	a,#0x06
      0082D0 F0               [24]  673 	movx	@dptr,a
      0082D1 90 01 3D         [24]  674 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0003)
      0082D4 74 12            [12]  675 	mov	a,#0x12
      0082D6 F0               [24]  676 	movx	@dptr,a
      0082D7 90 01 3E         [24]  677 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0004)
      0082DA E4               [12]  678 	clr	a
      0082DB F0               [24]  679 	movx	@dptr,a
      0082DC 8C 03            [24]  680 	mov	ar3,r4
      0082DE 90 01 3F         [24]  681 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0005)
      0082E1 EB               [12]  682 	mov	a,r3
      0082E2 F0               [24]  683 	movx	@dptr,a
      0082E3 90 01 40         [24]  684 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0006)
      0082E6 EF               [12]  685 	mov	a,r7
      0082E7 F0               [24]  686 	movx	@dptr,a
      0082E8 8E 07            [24]  687 	mov	ar7,r6
      0082EA 90 01 41         [24]  688 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0007)
      0082ED EF               [12]  689 	mov	a,r7
      0082EE F0               [24]  690 	movx	@dptr,a
      0082EF 90 01 42         [24]  691 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0008)
      0082F2 ED               [12]  692 	mov	a,r5
      0082F3 F0               [24]  693 	movx	@dptr,a
      0082F4 90 01 43         [24]  694 	mov	dptr,#(_mp3_play_mp3_buf_65537_5 + 0x0009)
      0082F7 74 EF            [12]  695 	mov	a,#0xef
      0082F9 F0               [24]  696 	movx	@dptr,a
                                    697 ;	src\mp3_serial.c:20: for(i=0;i<10;i++){
      0082FA 7F 00            [12]  698 	mov	r7,#0x00
      0082FC                        699 00107$:
                                    700 ;	src\mp3_serial.c:21: mp3_SBUF = mp3_buf[i];
      0082FC EF               [12]  701 	mov	a,r7
      0082FD 24 3A            [12]  702 	add	a,#_mp3_play_mp3_buf_65537_5
      0082FF F5 82            [12]  703 	mov	dpl,a
      008301 E4               [12]  704 	clr	a
      008302 34 01            [12]  705 	addc	a,#(_mp3_play_mp3_buf_65537_5 >> 8)
      008304 F5 83            [12]  706 	mov	dph,a
      008306 E0               [24]  707 	movx	a,@dptr
      008307 F5 9B            [12]  708 	mov	_S2BUF,a
                                    709 ;	src\mp3_serial.c:22: while(!mp3_TI)WATCHDOG;
      008309                        710 00103$:
      008309 E5 9A            [12]  711 	mov	a,_S2CON
      00830B 03               [12]  712 	rr	a
      00830C 54 01            [12]  713 	anl	a,#0x01
      00830E 70 05            [24]  714 	jnz	00105$
      008310 43 C1 10         [24]  715 	orl	_WDT_CONTR,#0x10
      008313 80 F4            [24]  716 	sjmp	00103$
      008315                        717 00105$:
                                    718 ;	src\mp3_serial.c:23: S2CON &= 0xFD;
      008315 53 9A FD         [24]  719 	anl	_S2CON,#0xfd
                                    720 ;	src\mp3_serial.c:20: for(i=0;i<10;i++){
      008318 0F               [12]  721 	inc	r7
      008319 BF 0A 00         [24]  722 	cjne	r7,#0x0a,00131$
      00831C                        723 00131$:
      00831C 40 DE            [24]  724 	jc	00107$
                                    725 ;	src\mp3_serial.c:25: }
      00831E 22               [24]  726 	ret
                                    727 	.area CSEG    (CODE)
                                    728 	.area CONST   (CODE)
                                    729 	.area XINIT   (CODE)
