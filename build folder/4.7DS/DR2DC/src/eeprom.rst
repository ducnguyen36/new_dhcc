      ...
      0002C7 22               [24]  571 	ret
                                    ...
                                    581 ;	-----------------------------------------
      0002C8                        582 _IAP_docbyte:
      0002C8 AE 82            [24]  583 	mov	r6,dpl
      0002CA AF 83            [24]  584 	mov	r7,dph
                                    585 ;	src\eeprom.c:17: IAP_CONTR = ENABLE_IAP;
      0002CC 75 C7 83         [24]  586 	mov	_IAP_CONTR,#0x83
                                    587 ;	src\eeprom.c:18: IAP_CMD = CMD_READ;
      0002CF 75 C5 01         [24]  588 	mov	_IAP_CMD,#0x01
                                    589 ;	src\eeprom.c:19: IAP_ADDRL = diachi;
      0002D2 8E C4            [24]  590 	mov	_IAP_ADDRL,r6
                                    591 ;	src\eeprom.c:20: IAP_ADDRH = diachi>>8;
      0002D4 8F C3            [24]  592 	mov	_IAP_ADDRH,r7
                                    593 ;	src\eeprom.c:21: IAP_TRIG = 0x5a;
      0002D6 75 C6 5A         [24]  594 	mov	_IAP_TRIG,#0x5a
                                    595 ;	src\eeprom.c:22: IAP_TRIG = 0xa5;
      0002D9 75 C6 A5         [24]  596 	mov	_IAP_TRIG,#0xa5
                                    597 ;	src\eeprom.c:23: _nop_();
      0002DC 00               [12]  598 	NOP	
                                    599 ;	src\eeprom.c:24: dulieu = IAP_DATA;
      0002DD AF C2            [24]  600 	mov	r7,_IAP_DATA
                                    601 ;	src\eeprom.c:25: IAP_cho();
      0002DF C0 07            [24]  602 	push	ar7
      0002E1 12 02 B5         [24]  603 	lcall	_IAP_cho
      0002E4 D0 07            [24]  604 	pop	ar7
                                    605 ;	src\eeprom.c:26: return dulieu;
      0002E6 8F 82            [24]  606 	mov	dpl,r7
                                    607 ;	src\eeprom.c:27: }
      0002E8 22               [24]  608 	ret
                                    609 ;------------------------------------------------------------
                                    ...
                                    618 ;	-----------------------------------------
      0002E9                        619 _IAP_ghibyte:
      0002E9 AE 82            [24]  620 	mov	r6,dpl
      0002EB AF 83            [24]  621 	mov	r7,dph
                                    622 ;	src\eeprom.c:30: IAP_CONTR = ENABLE_IAP;
      0002ED 75 C7 83         [24]  623 	mov	_IAP_CONTR,#0x83
                                    624 ;	src\eeprom.c:31: IAP_CMD = CMD_PROGRAM;
      0002F0 75 C5 02         [24]  625 	mov	_IAP_CMD,#0x02
                                    626 ;	src\eeprom.c:32: IAP_ADDRL = diachi;
      0002F3 8E C4            [24]  627 	mov	_IAP_ADDRL,r6
                                    628 ;	src\eeprom.c:33: IAP_ADDRH = diachi>>8;
      0002F5 8F C3            [24]  629 	mov	_IAP_ADDRH,r7
                                    630 ;	src\eeprom.c:34: IAP_DATA = dulieu;
      0002F7 85 18 C2         [24]  631 	mov	_IAP_DATA,_IAP_ghibyte_PARM_2
                                    632 ;	src\eeprom.c:35: IAP_TRIG = 0x5a;
      0002FA 75 C6 5A         [24]  633 	mov	_IAP_TRIG,#0x5a
                                    634 ;	src\eeprom.c:36: IAP_TRIG = 0xa5;
      0002FD 75 C6 A5         [24]  635 	mov	_IAP_TRIG,#0xa5
                                    636 ;	src\eeprom.c:37: _nop_();
      000300 00               [12]  637 	NOP	
                                    638 ;	src\eeprom.c:38: IAP_cho();
                                    639 ;	src\eeprom.c:39: }
      000301 02 02 B5         [24]  640 	ljmp	_IAP_cho
                                    641 ;------------------------------------------------------------
                                    ...
                                    649 ;	-----------------------------------------
      000304                        650 _IAP_xoasector:
      000304 AE 82            [24]  651 	mov	r6,dpl
      000306 AF 83            [24]  652 	mov	r7,dph
                                    653 ;	src\eeprom.c:42: IAP_CONTR = ENABLE_IAP;
      000308 75 C7 83         [24]  654 	mov	_IAP_CONTR,#0x83
                                    655 ;	src\eeprom.c:43: IAP_CMD = CMD_ERASE;
      00030B 75 C5 03         [24]  656 	mov	_IAP_CMD,#0x03
                                    657 ;	src\eeprom.c:44: IAP_ADDRL = sector;
      00030E 8E C4            [24]  658 	mov	_IAP_ADDRL,r6
                                    659 ;	src\eeprom.c:45: IAP_ADDRH = sector>>8;
      000310 8F C3            [24]  660 	mov	_IAP_ADDRH,r7
                                    661 ;	src\eeprom.c:46: IAP_TRIG = 0x5a;
      000312 75 C6 5A         [24]  662 	mov	_IAP_TRIG,#0x5a
                                    663 ;	src\eeprom.c:47: IAP_TRIG = 0xa5;
      000315 75 C6 A5         [24]  664 	mov	_IAP_TRIG,#0xa5
                                    665 ;	src\eeprom.c:48: _nop_();
      000318 00               [12]  666 	NOP	
                                    667 ;	src\eeprom.c:49: IAP_cho();
                                    668 ;	src\eeprom.c:51: }
      000319 02 02 B5         [24]  669 	ljmp	_IAP_cho
                                    670 ;------------------------------------------------------------
                                    ...
                                    678 ;	-----------------------------------------
      00031C                        679 _IAP_docxoasector1:
                                    680 ;	src\eeprom.c:56: WATCHDOG;
      00031C 43 C1 10         [24]  681 	orl	_WDT_CONTR,#0x10
                                    682 ;	src\eeprom.c:57: while(i) eeprom_buf[--i] = 0xff;
      00031F 7F 20            [12]  683 	mov	r7,#0x20
      000321                        684 00101$:
      000321 EF               [12]  685 	mov	a,r7
      000322 60 10            [24]  686 	jz	00112$
      000324 1F               [12]  687 	dec	r7
      000325 EF               [12]  688 	mov	a,r7
      000326 24 BD            [12]  689 	add	a,#_eeprom_buf
      000328 F5 82            [12]  690 	mov	dpl,a
      00032A E4               [12]  691 	clr	a
      00032B 34 00            [12]  692 	addc	a,#(_eeprom_buf >> 8)
      00032D F5 83            [12]  693 	mov	dph,a
      00032F 74 FF            [12]  694 	mov	a,#0xff
      000331 F0               [24]  695 	movx	@dptr,a
                                    696 ;	src\eeprom.c:59: while(i<SECTOR1_LENGTH) eeprom_buf[i] = *(&eep_motor+i++);
      000332 80 ED            [24]  697 	sjmp	00101$
      000334                        698 00112$:
      000334                        699 00104$:
      000334 BF 20 00         [24]  700 	cjne	r7,#0x20,00128$
      000337                        701 00128$:
      000337 50 18            [24]  702 	jnc	00106$
      000339 EF               [12]  703 	mov	a,r7
      00033A 24 BD            [12]  704 	add	a,#_eeprom_buf
      00033C FD               [12]  705 	mov	r5,a
      00033D E4               [12]  706 	clr	a
      00033E 34 00            [12]  707 	addc	a,#(_eeprom_buf >> 8)
      000340 FE               [12]  708 	mov	r6,a
      000341 8F 82            [24]  709 	mov	dpl,r7
      000343 75 83 F0         [24]  710 	mov	dph,#(_eep_motor >> 8)
      000346 0F               [12]  711 	inc	r7
      000347 E4               [12]  712 	clr	a
      000348 93               [24]  713 	movc	a,@a+dptr
      000349 FC               [12]  714 	mov	r4,a
      00034A 8D 82            [24]  715 	mov	dpl,r5
      00034C 8E 83            [24]  716 	mov	dph,r6
      00034E F0               [24]  717 	movx	@dptr,a
      00034F 80 E3            [24]  718 	sjmp	00104$
      000351                        719 00106$:
                                    720 ;	src\eeprom.c:61: IAP_xoasector(SECTOR1);
      000351 90 00 00         [24]  721 	mov	dptr,#0x0000
                                    722 ;	src\eeprom.c:62: }
      000354 02 03 04         [24]  723 	ljmp	_IAP_xoasector
                                    724 ;------------------------------------------------------------
                                    ...
                                    732 ;	-----------------------------------------
      000357                        733 _IAP_ghisector1:
                                    734 ;	src\eeprom.c:66: while(i<SECTOR1_LENGTH){
      000357 7F 00            [12]  735 	mov	r7,#0x00
      000359                        736 00101$:
      000359 BF 20 00         [24]  737 	cjne	r7,#0x20,00115$
      00035C                        738 00115$:
      00035C 50 29            [24]  739 	jnc	00104$
                                    740 ;	src\eeprom.c:67: IAP_CONTR = ENABLE_IAP;
      00035E 75 C7 83         [24]  741 	mov	_IAP_CONTR,#0x83
                                    742 ;	src\eeprom.c:68: IAP_CMD = CMD_PROGRAM;
      000361 75 C5 02         [24]  743 	mov	_IAP_CMD,#0x02
                                    744 ;	src\eeprom.c:69: IAP_ADDRL = i;
      000364 8F C4            [24]  745 	mov	_IAP_ADDRL,r7
                                    746 ;	src\eeprom.c:70: IAP_ADDRH = 0;
      000366 75 C3 00         [24]  747 	mov	_IAP_ADDRH,#0x00
                                    748 ;	src\eeprom.c:71: IAP_DATA = eeprom_buf[i++];
      000369 EF               [12]  749 	mov	a,r7
      00036A 24 BD            [12]  750 	add	a,#_eeprom_buf
      00036C F5 82            [12]  751 	mov	dpl,a
      00036E E4               [12]  752 	clr	a
      00036F 34 00            [12]  753 	addc	a,#(_eeprom_buf >> 8)
      000371 F5 83            [12]  754 	mov	dph,a
      000373 0F               [12]  755 	inc	r7
      000374 E0               [24]  756 	movx	a,@dptr
      000375 F5 C2            [12]  757 	mov	_IAP_DATA,a
                                    758 ;	src\eeprom.c:72: IAP_TRIG = 0x5a;
      000377 75 C6 5A         [24]  759 	mov	_IAP_TRIG,#0x5a
                                    760 ;	src\eeprom.c:73: IAP_TRIG = 0xa5;
      00037A 75 C6 A5         [24]  761 	mov	_IAP_TRIG,#0xa5
                                    762 ;	src\eeprom.c:74: _nop_();
      00037D 00               [12]  763 	NOP	
                                    764 ;	src\eeprom.c:75: IAP_cho();
      00037E C0 07            [24]  765 	push	ar7
      000380 12 02 B5         [24]  766 	lcall	_IAP_cho
      000383 D0 07            [24]  767 	pop	ar7
      000385 80 D2            [24]  768 	sjmp	00101$
      000387                        769 00104$:
                                    770 ;	src\eeprom.c:77: }
      000387 22               [24]  771 	ret
                                    772 	.area CSEG    (CODE)
                                    773 	.area CONST   (CODE)
